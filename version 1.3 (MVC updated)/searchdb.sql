...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2020 at 03:42 PM
...
(1, 'individual', 'girls', 3, 6000, 45, '../resource/Images/h1.jpg', '4', 'mal mawatha', 'Dalthara', 12949, 'Colombo', 'near to university of Moratuwa', 'https://goo.gl/maps/LtzP1M2NrkFUHpMb6', 2, 2000, 'aada'),
(2, 'individual', 'boys', 4, 5500, 30, '../resource/Images/h1.jpg', '12/A', 'kammalawaththa mawatha', 'kotuwa', 10788, 'Mathara', 'near to university of Ruhuna', 'https://goo.gl/maps/AUW3hP4ryNcxPEvDA', 3, 3000, ' xdgxtdh'),
(3, 'room', 'girls', 2, 7000, 70, '../resource/Images/h1.jpg', '4', 'mal mawatha', 'Moratuwa', 12949, 'Colombo', 'near to university of Moratuwa', 'https://goo.gl/maps/LtzP1M2NrkFUHpMb6', 2, 2000, ' dfsdsfs'),
(4, 'room', 'boys', 3, 6500, 60, '../resource/Images/h1.jpg', '111/A', 'kammalawaththa mawatha', 'Maharagama', 10788, 'Colombo', 'near to university of jayawardhanapura', 'https://goo.gl/maps/9Rj41yabhqRgW7Mx5', 3, 3000, ' vfgdth');
...
(4, 5, 'Nelum Kole Food court', 'game kaama game rasata', 'Highlevel road, Nugegoda', '', '', 35, '00:00:18', 6, 6000, '../resource/Images/uploaded_foodpost/nelum kole.jpg'),
...
(6, 5, 'Ranasiri Bakery', 'All bakery food dine in and delivary', 'sisil Mawatha,Wijayaraama', '', '', 35, '00:00:20', 6, 6000, '../resource/Images/uploaded_foodpost/bakery.jpg');
...
ALTER TABLE `food_post`
  ADD PRIMARY KEY (`F-post-id`) USING BTREE,
  ADD KEY `FSid` (`FSid`);
